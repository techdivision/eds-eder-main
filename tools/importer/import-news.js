...
export default {
  transform: ({
    ...
    if (news.section !== targetSection && !targetSection.includes(news.section)) {
      /* eslint-disable no-console */
      console.log(`This news will not be imported, as its section '${news.section}' does not match the section '${targetSection}' of the current import`);
      /* eslint-enable no-console */
      return [];
    }
